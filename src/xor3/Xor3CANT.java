...
public class Xor3CANT extends CANT23{
  public static boolean learnWhileTesting = false;//true;
  public static int  spontaneousOnlyCycles = 0;//2000;
	
  public static String ExperimentXMLFile;
  public static xor3Net nullNet;
  public static xor3Experiment experiment; 
...
System.out.println("initialize CANT xor3");
    fWorks = true;
    //fWorks = false;
    if (fWorks) 
      ExperimentXMLFile = "src/xor3/xorWork.xml";
    else 
  ...
  protected static void readNewSystem() {
    ...
    workerThread = new Xor3CANT.WorkerThread();
    initializeExperiment();
    experiment.printExpName();
    xor3Net net = (xor3Net) experiment.getNet("BaseNet");
    workerThread.start();	
    connectAllNets();	
    inputModel = 2;
    }
  ...
  private static void connectAllNets() {
    xor3Net baseNet = (xor3Net)experiment.getNet("BaseNet");
    xor3Net outputNet = (xor3Net)experiment.getNet("OutputNet");
	
    if (fWorks) {
      xor3Net gasNet = (xor3Net)experiment.getNet("GasNet");
